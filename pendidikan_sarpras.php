        ...
        <div class="navbar-nav">
          ...
          <li class="nav-item dropdown active nav-aktif">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="dropdown-item active nav-aktif" href="pendidikan_sarpras.php">Pendidikan</a>
    ...
    <div class="row">
      <div class="col-9">
        ...
        <div class="menu rounded-lg">
          <h4 class="tulisan-menu">Prasarana dan Sarana Pendidikan</h4>
        </div> <br>
        <div class="row isi">
          ...
          <div class="col-sm">
            <table class="table table-bordered">
              <thead>
                <tr>
                  <th scope="col" style="text-align: center;">Prasarana dan Sarana</th>
              ...
              <tbody>
                <tr>
                  <td scope="row">Gedung Kampus PTS</td>
                </tr>
                <tr>
                  <td scope="row">Gedung SMP/sederajat</td>
                </tr>
                <tr>
                  <td scope="row">Gedung SD/sederajat</td>
                </tr>
                <tr>
                  <td scope="row">Gedung TK</td>
                </tr>
                <tr>
                  <td scope="row">Taman Bacaan</td>
                </tr>
              </tbody>           
            </table> <br>
