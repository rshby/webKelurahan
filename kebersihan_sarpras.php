    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a class="nav-item nav-link" href="gambaranumum.php.php">Gambaran Umum<span class="sr-only">(current)</span></a>
          ...
          <li class="nav-item dropdown active nav-aktif">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="dropdown-item active nav-aktif" href="kebersihan_sarpras.php">Kebersihan</a>
            </div>
          </li>
    ...
    <div class="row">
      <div class="col-9">
        ...
        <div class="menu rounded-lg">
          <h4 class="tulisan-menu">Prasarana dan Sarana Kebersihan</h4>
        </div>
        <div class="row isi">
          <div class="col-sm">
